      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 8 }}>
          <span style={{
            ...
            background: connected ? "#10b981" : reconnecting ? "#f59e0b" : "#4b6280",
            boxShadow:  connected ? "0 0 7px #10b981" : "none",
            animation:  connected ? "pulse-glow 2s ease infinite" : "none",
          }} />
          <span style={{ fontSize: "0.66rem", color: connected ? "#34d399" : "#64748b" }}>
            {connected ? "Live · real-time updates" : reconnecting ? "Reconnecting…" : "Disconnected"}
          </span>
        </div>
      </div>
